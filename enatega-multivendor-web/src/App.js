...
import Paystack from "./screens/Paystack/Paystack";
      ...
      if (await isFirebaseSupported()) {
        ...
        Notification.requestPermission()
          .then(() => {
            getToken(messaging, {
              vapidKey:
                "AAAA8fb6d4g:APA91bHLd6Q19mwka4ET0v2SiGuIizbm4CaivXRYdf9p8aLcKKJY19dtpX1xSc5RS3Qf1xQVSKfaVe_3oY7Pe-hV_9KRER_aSqHOnQXcaM5kKobvc-DW06q7XUHlUrI3AuAyqsH_8uZX",
            })
              .then((token) => {
