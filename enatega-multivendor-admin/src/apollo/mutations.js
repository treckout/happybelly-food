...
export const savePaystackConfiguration = `mutation SavePaystackConfiguration($configurationInput:PaystackConfigurationInput!){
  savePaystackConfiguration(configurationInput:$configurationInput){
    _id
    publishableKey
    secretKey
  }
