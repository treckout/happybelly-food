              ...
              <Grid container p={3}>
                <Grid item md={9}>
                  <Typography
                    ...
                    HappyBelly Adim page
                  </Typography>
                  <Typography sx={{ fontSize: 15, color: '#CDCDCD' }}>
                    A full fledged solution highly suitable to manage multi-restaurants.
                  </Typography>
                  <ButtonBase
                    onClick={() =>
                      (window.location.href = 'https://happybelly.site/')
                    }
                    variant="contained"
                    sx={{ width: '30%' }}
